...
<div style="text-align:center;">
	...
	<form method="post">
		...
		<label for="PhoneNo" class="p2">Phone Number:</label><br>
		<input type="text" name="phoneno" placeholder="Phone No." required><br><br>
    ...
    if(isset($_POST['submit']))
	{
	 ...
	 {
	 	$query4="UPDATE loginfo set staffno='$StaffNo' where password='$pwd'";
	 	$result4=mysqli_query($conn,$query4);
	 	$_SESSION['StaffNo']=$StaffNo;
	 }
	 if(isset($_POST['phoneno']))
	 {
	 	$query5="UPDATE loginfo set phoneno='$phoneno' where staffno='$staff' and password='$pwd'";
